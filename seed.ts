...
const assignments = [
  {
    id: "asmt_0001", workOrderId: "wo_0001", projectId: null, techId: TECH_ID, techName: "Corey Williams",
  ...
  {
    id: "asmt_0002", workOrderId: "wo_0002", projectId: null, techId: TECH_ID, techName: "Corey Williams",
    status: "scheduled", acknowledgmentStatus: "pending", scheduledAt: "2026-04-04T12:00:00Z",
    acknowledgedAt: null, acknowledgmentRequiredAt: "2026-04-04T10:00:00Z", currentScheduledDate: "2026-04-04T12:00:00Z",
    latestOutcomeCode: null, needsAdminReview: false, revisitCount: 0, active: true,
    acknowledgmentMissed: false, removedAfterAcknowledgment: false, removedAt: null, removedBy: null,
  ...
  {
    id: "asmt_0003", workOrderId: "wo_0003", projectId: null, techId: TECH_ID, techName: "Corey Williams",
    status: "scheduled", acknowledgmentStatus: "pending", scheduledAt: "2026-04-04T12:00:00Z",
    acknowledgedAt: null, acknowledgmentRequiredAt: "2026-04-04T10:00:00Z", currentScheduledDate: "2026-04-04T12:00:00Z",
    latestOutcomeCode: null, needsAdminReview: false, revisitCount: 0, active: true,
    acknowledgmentMissed: false, removedAfterAcknowledgment: false, removedAt: null, removedBy: null,
  ...
  {
    id: "asmt_0004", workOrderId: "wo_0004", projectId: "proj_0001", techId: TECH_ID, techName: "Corey Williams",
...
const assignmentTimeLogs = [
  {
    _parentId: "asmt_0002", id: "tl_0001", assignmentId: "asmt_0002", workOrderId: "wo_0002", techId: TECH_ID,
  ...
  {
    _parentId: "asmt_0003", id: "tl_0001", assignmentId: "asmt_0003", workOrderId: "wo_0003", techId: TECH_ID,
...
const weeklyLogItems = [
  { _parentId: "wl_0001", id: "wli_0001", weeklyLogId: "wl_0001", assignmentId: "asmt_0001", workOrderId: "wo_0001", techId: TECH_ID, displayTitle: "Network Equipment Issues", displayLocationText: "Grosse Pointe, MI 48230", displayScheduledDate: "2026-04-04T12:00:00Z", didWork: true, isCompleted: false, outcomeCode: "worked_revisit_same_work_order", didNotWorkReasonCode: null, incompleteReasonCode: "revisit_same_work_order", needsAdminReview: true, reviewNote: "Need follow-up visit after first attempt.", createdAt: "2026-04-04T12:00:00Z", updatedAt: "2026-04-04T12:00:00Z" },
  { _parentId: "wl_0001", id: "wli_0002", weeklyLogId: "wl_0001", assignmentId: "asmt_0002", workOrderId: "wo_0002", techId: TECH_ID, displayTitle: "Front Camera Offline", displayLocationText: "Detroit, MI", displayScheduledDate: "2026-04-04T12:00:00Z", didWork: true, isCompleted: true, outcomeCode: "worked_completed", didNotWorkReasonCode: null, incompleteReasonCode: null, needsAdminReview: false, reviewNote: "Resolved on site.", createdAt: "2026-04-04T12:00:00Z", updatedAt: "2026-04-04T12:00:00Z" },
  { _parentId: "wl_0001", id: "wli_0003", weeklyLogId: "wl_0001", assignmentId: "asmt_0003", workOrderId: "wo_0003", techId: TECH_ID, displayTitle: "Follow-Up Camera Adjustment", displayLocationText: "Ann Arbor, MI", displayScheduledDate: "2026-04-04T12:00:00Z", didWork: true, isCompleted: true, outcomeCode: "worked_completed", didNotWorkReasonCode: null, incompleteReasonCode: null, needsAdminReview: false, reviewNote: "Manual follow-up completed.", createdAt: "2026-04-04T12:00:00Z", updatedAt: "2026-04-04T12:00:00Z" },
];

const clientRequests = [
  { id: "creq_0001", clientId: CLIENT_ID, clientName: "Premium Brands Contact", createdBy: CLIENT_ID, title: "Front Camera Offline", description: "The front entrance camera is not showing video.", locationText: "Detroit, MI", requestType: "troubleshooting", priority: "high", preferredDate: "2026-04-04T12:00:00Z", attachments: [], status: "approved", convertedWorkOrderId: "wo_0002", convertedAt: "2026-04-04T12:00:00Z", convertedBy: ADMIN_ID, adminNotes: null, createdAt: "2026-04-04T12:00:00Z", updatedAt: "2026-04-04T12:00:00Z" },
];
...
const financialRecords = [
  { id: "fin_0001", type: "reimbursement", techId: TECH_ID, workOrderId: "wo_0002", assignmentId: "asmt_0002", weeklyLogId: "wl_0001", weeklyLogItemId: "wli_0002", projectId: null, amount: 45, category: "materials", note: "Purchased replacement connector on site.", receiptUrls: [], reviewStatus: "pending", paymentStatus: "unpaid", createdBy: TECH_ID, createdAt: "2026-04-04T12:00:00Z", reviewedBy: null, reviewedAt: null },
];

const penaltyEvents = [
  { id: "pen_0001", techId: TECH_ID, type: "late_log", points: 3, assignmentId: null, workOrderId: null, weeklyLogId: "wl_0001", recordedBy: ADMIN_ID, note: "Weekly log submitted after due date.", createdAt: "2026-04-07T08:00:00Z" },
];
...
const sites = [
  { id: "site_0001", clientId: CLIENT_ID, clientName: "Premium Brands Contact", siteName: "Premium Brands – Detroit Flagship", locationText: "Detroit, MI", siteGeo: { lat: 42.3314, lng: -83.0458 }, managerName: "Jordan Lee", managerPhone: "555-700-2000", siteAccessInstructions: "Check in at front desk, ask for Jordan.", status: "active", createdAt: "2026-04-04T12:00:00Z", updatedAt: "2026-04-04T12:00:00Z" },
];

const siteRequests = [
  { id: "sreq_0001", clientId: CLIENT_ID, clientName: "Premium Brands Contact", siteName: "Premium Brands – Wixom Distribution", locationText: "Wixom, MI", managerName: "Sam Torres", managerPhone: "555-700-3000", status: "approved", convertedSiteId: null, reviewedBy: ADMIN_ID, reviewedAt: "2026-04-17T00:00:00Z", createdAt: "2026-04-15T00:00:00Z", updatedAt: "2026-04-17T00:00:00Z" },
];

const notifications = [
  { id: "notif_0001", userId: TECH_ID, type: "weekly_log_reminder", relatedId: "wl_0001", relatedEntityType: "weeklyLog", channel: "email", scheduledFor: "2026-04-06T09:00:00Z", sentAt: null, attemptCount: 0, lastAttemptAt: null, deliveryStatus: "queued", deliveryError: null, message: "Your weekly log for the week of Mar 30 is due by end of day Monday." },
  { id: "notif_0002", userId: TECH_ID, type: "acknowledgment_reminder", relatedId: "asmt_0004", relatedEntityType: "assignment", channel: "push", scheduledFor: "2026-04-21T08:00:00Z", sentAt: null, attemptCount: 0, lastAttemptAt: null, deliveryStatus: "queued", deliveryError: null, message: "Please acknowledge your assignment for Apr 22 by 5:00 PM today." },
];

const messages = [
  { id: "msg_0001", senderId: ADMIN_ID, senderName: "Admin", recipientIds: [TECH_ID], type: "system", content: "Welcome to the Aaromach platform. Your assignments and project details will appear here.", relatedEntityType: null, relatedEntityId: null, isRead: false, createdAt: "2026-04-17T00:00:00Z", updatedAt: "2026-04-17T00:00:00Z" },
];

const timeOffRequests = [
  { id: "tor_0001", userId: TECH_ID, userName: "Corey Williams", type: "personal", startDate: "2026-04-25", endDate: "2026-04-26", reason: "Personal time off", status: "pending", reviewedBy: null, reviewedAt: null, notes: null, createdAt: "2026-04-17T00:00:00Z", updatedAt: "2026-04-17T00:00:00Z" },
];
...
function clean(doc: AnyDoc, ...omit: string[]): AnyDoc {
  return Object.fromEntries(Object.entries(doc).filter(([k]) => !omit.includes(k)));
}
