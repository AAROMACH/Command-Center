...
import { Import as ImportIcon, Loader2, AlertTriangle, CircleCheck, ChevronRight, ArrowLeft, MapPin, Pencil, Building2 } from 'lucide-react';
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div onDoubleClick={() => !job.isDuplicate && setEditingField({ id: job.id, field: 'title' })}>
                                                {editingField?.id === job.id && editingField.field === 'title' ? (
                                                    ...
                                                    <p className="text-xs font-bold text-text-primary uppercase tracking-wide flex items-center gap-2 group-hover:text-brand-red transition-colors text-left">
                                                        {job.title}
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <div onDoubleClick={() => !job.isDuplicate && setEditingField({ id: job.id, field: 'clientName' })}>
                                                    {editingField?.id === job.id && editingField.field === 'clientName' ? (
                                                        ...
                                                        <div className="flex items-center gap-2 text-[10px] text-text-muted font-bold uppercase tracking-widest text-left">
                                                            <Building2 size={12}/>
