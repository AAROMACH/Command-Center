  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "w-fit",
        month_caption: "flex justify-center items-center h-9 w-full relative mb-1",
        ...
        weekdays: "flex",
        weekday: "text-muted-foreground font-normal text-[0.8rem] flex items-center justify-center w-9 h-9",
